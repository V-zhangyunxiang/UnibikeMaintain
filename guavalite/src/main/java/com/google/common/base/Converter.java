 ...
 * example round-trip using {@_link com.google.common.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *
 * <ul>
 * <li>Use a provided converter implementation, such as {@link Enums#stringConverter}, {@_link
 *     com.google.common.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@_link
 ...
 *     java.util.function.Function} is accepted (for example {@_link Stream#map}).
